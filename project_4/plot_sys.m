%% Plotting function
function plot_sys(data, est_mean, est_std)
  plot_states(data.x, data.t, est_mean, est_std)
  plot_control(data.u, data.t)
  plot_dist(data.w, data.t)
end

function plot_states(states, t, est_mean, est_std)
  figure()
  subplot(3, 2, 1);
  plot(t, states(:, 1), 'c', LineWidth = 2, DisplayName = "x_{G1}");
  hold on
  ...
  subplot(3, 2, 2);
  plot(t, states(:, 2), 'c', LineWidth = 2, DisplayName = "x_{G2}");
  hold on
  ...
  subplot(3, 2, 3);
  plot(t, states(:, 3), 'c', LineWidth = 2, DisplayName = "x_{G3}");
  hold on
  ...
  subplot(3, 2, 4);
  plot(t, states(:, 4), 'c', LineWidth = 2, DisplayName = "x_{G4}");
  hold on
  ...
  subplot(3, 2, 5);
  plot(t, states(:, 5), 'c', LineWidth = 2, DisplayName = "x_{G5}");
  hold on
  ...
  subplot(3, 2, 6);
  plot(t, states(:, 6), 'c', LineWidth = 2, DisplayName = "x_{G6}");
  hold on
